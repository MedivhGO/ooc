...
static void _some_method(T_Shape *me_super, int a, int b)
{
   ...
   T_Circle *me = circle__get_by_shape(me_super);
...
{
   memset(me, 0x00, sizeof(T_Circle));
...
{
   T_Circle *me = (T_Circle *)OOC_MALLOC( sizeof(T_Circle) );
   circle__ctor(me, p_params);
   return me;
}
